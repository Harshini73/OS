	...
	public void init(){
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int d;
				int i=0;
				//Integer.parseInt(textField_8.getText());//start
				//i++;
				d=Integer.parseInt(textField_7.getText());//end
				//i++;
				process[i]=Integer.parseInt(textField.getText());
				int head=process[i];
				i++;
		...
		JLabel lblEnd = new JLabel("direction");
